...
// Написати програму яка отримає від користувача число (кількість хвилин) і виведе на екран строку в форматі
//               години і хвилини Приклад 70 покаже 1:10 450 покаже 7:30 1441 покаже 24:1
let value = Number(prompt('Введите количество минут'));
let hour = Math.floor(value / 60);
let minutes = value - hour * 60;
alert(`Ваше время ${hour}:${minutes}`);

//------------------------------------------------------------------------------------------------------------

// Написати гру камінь ножиці папір. Де компютер загадує своє значення потім користувач вводить свій варіант
//               і далі ми бачимо результат на екпані хто виграв

//1=камень, 2=ножницы, 3=бумага
let compValue = Math.round(Math.random() * (3 - 1) + 1);
// console.log(compValue);
let myValue = prompt('Введите "камень", "ножницы" или "бумагу"');
let message;
switch (compValue) {
  case 1:
    if (myValue === 'камень') {
      message = alert('камень VS камень - ничья, победила дружба!');
    } else if (myValue === 'ножницы') {
      message = alert('камень VS ножницы - победил компьютер');
    } else if (myValue === 'бумага') {
      message = alert('камень VS бумага - Вы победили');
    } else {
  ...
  case 2:
    if (myValue === 'ножницы') {
      message = alert('ножницы VS ножницы - ничья, победила дружба!');
    } else if (myValue === 'бумага') {
      message = alert('ножницы VS бумага - победил компьютер');
    } else if (myValue === 'камень') {
      message = alert('ножницы VS камень - Вы победили');
    } else {
      alert('Ошибка в введенных данных');
    }
    break;
  case 3:
    if (myValue === 'бумага') {
      message = alert('бумага VS бумага - ничья, победила дружба!');
    } else if (myValue === 'камень') {
      message = alert('бумага VS камень - победил компьютер');
    } else if (myValue === 'ножницы') {
      message = alert('бумага VS ножницы - Вы победили');
    } else {
      alert('Ошибка в введенных данных');
    }
    break;
